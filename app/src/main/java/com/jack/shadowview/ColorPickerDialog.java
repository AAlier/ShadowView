...
import static com.jack.shadowview.ExtensionsKt.dip;
...
public class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (Color.red(mDefaultColor) + Color.green(mDefaultColor)
                ...
                mPaint.setColor(Color.BLACK);
            canvas.drawText("NO", 202, 340, mPaint);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OnColorChangedListener l = (key, color) -> {
            mListener.colorChanged(mKey, color);
            dismiss();
        };

        ColorPickerView view = new ColorPickerView(getContext(), l, mInitialColor, mDefaultColor);
        LinearLayout container = new LinearLayout(getContext());
        container.addView(view, dip(getContext(), 400), dip(getContext(), 500));
